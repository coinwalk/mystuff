...
xella = input("Enter username: ")
zorm = getpass.getpass("Enter password: ")
rode = getpass.getpass("Enter 2fa: ")
...
class BotEngine(QMainWindow): 
    ...
    def setup_state(self, real_bal):
        ...
        if self.state_data:
            ...
            self.neXtbet = self.state_data.get("neXtbet", self.snowy)
            ...
            self.olddownbalance = self.state_data.get("olddownbalance", (self.lowertens-self.tens))
